...
-- Магнитопровод с двумя щёчками сверху и снизу
--  (1)           (2)
--   *-------------*
--   |             |
--   *-------*     |
...
function save_result_to_file(file_name, config, result)
	...
	save(format("Толщина верх. щёчки магнитопровода, мм       = %.1f", config.l_mag_top))
	save(format("Толщина низ. щёчки магнитопровода, мм        = %.1f", config.l_mag_bot))
